        ...
        <div class="relative max-lg:row-start-1 lg:row-span-2 group">
          ...
          <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)] transition-shadow duration-300 group-hover:shadow-lg">
            ...
            <div class="@container relative min-h-[20rem] sm:min-h-[28rem] w-full grow max-lg:mx-auto max-lg:max-w-sm">
                <img class="size-full object-cover object-top" src="/missedcall.webp" alt="Callwell answering calls automatically" loading="lazy" decoding="async" width="400" height="600" />
              </div>
          </div>
        ...
        <div class="relative max-lg:row-start-4 group">
          ...
          <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)] transition-shadow duration-300 group-hover:shadow-lg">
            ...
            <div class="@container flex flex-1 items-center justify-center max-lg:py-8 lg:py-4 px-8">
              <img src="/routing.webp" alt="Intelligent routing with human in the loop" class="w-full max-w-md object-contain" loading="lazy" decoding="async" width="480" height="320" />
            </div>         
         </div>
        ...
        <div class="relative max-lg:row-start-2 lg:col-start-2 lg:row-start-2 group">
          ...
          <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] transition-shadow duration-300 group-hover:shadow-lg">
            <div class="px-8 pt-8 sm:px-10 sm:pt-10">
              ...
              <p class="mt-2 max-w-lg text-base text-gray-600 max-lg:text-center">Works with your CRM, calendar, and existing business tools to sync your appointments automatically.</p>
            </div>
            <div class="@container flex flex-1 items-center justify-center max-lg:py-6 lg:pb-2 px-8">
              <img class="w-full max-w-md object-contain" src="/integrations_generic.png" alt="Integrates seamlessly with your CRM and business tools" loading="lazy" decoding="async" />
            </div>
          </div>
