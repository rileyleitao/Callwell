              ...
              >
                <div class="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      name="firstName"
                      required
                      class="w-full px-4 py-3 border border-gray-300 rounded-md text-base focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      placeholder="John"
                      @focus="trackDemoFormField('firstName')"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      class="w-full px-4 py-3 border border-gray-300 rounded-md text-base focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      placeholder="Smith"
                      @focus="trackDemoFormField('lastName')"
                    />
                  </div>
                </div>
                ...
                <div>
                  <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                    <input
                      ...
                      @focus="trackDemoFormField('email')"
                    />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    :class="[
                      'w-full px-4 py-3 border rounded-md text-base focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent',
                      phoneError ? 'border-red-500' : 'border-gray-300'
                    ]"
                    placeholder="5551234567"
                    @input="onPhoneInput"
                    @focus="trackDemoFormField('phoneNumber')"
                  />
                ...
                <button
                  ...
                  class="w-full bg-indigo-600 text-white py-3 rounded-md text-base font-semibold hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
...
import { trackDemoFormField, trackDemoFormSubmit, trackDemoCallClick } from '../composables/useAnalytics'
