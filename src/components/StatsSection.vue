<template>
  <section class="bg-white py-12 sm:py-16 lg:py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Stats Grid -->
      <div class="bg-gray-50 rounded-2xl py-8 sm:py-12">
        <div class="grid grid-cols-2 lg:grid-cols-4 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
          ...
          <div class="text-center py-6 lg:py-0 px-4">
            <div class="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">100%</div>
            <div class="text-sm sm:text-base text-gray-600">Calls answered</div>
          </div>
          <div class="text-center py-6 lg:py-0 px-4">
            <div class="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">99.9%</div>
            <div class="text-sm sm:text-base text-gray-600">Uptime guarantee</div>
          </div>
          <div class="text-center py-6 lg:py-0 px-4">
            <div class="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">&lt;2s</div>
